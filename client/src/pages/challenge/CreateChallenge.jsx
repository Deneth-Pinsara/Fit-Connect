...
const CreateChallenge = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5001/api/challenges', formData, {
                headers: {
        ...
        <div>
            <div className="flex flex-col gap-8 space-y-2">
                ...
                <textarea
                    ...
                    rows={10}
                />
                <div className="flex flex-row contents-center justify-center mt-5">
                    <button
                        type="button"
                        onClick={nextStep}
                        className="bg-white text-black py-3 px-6 rounded-lg cursor-pointer"
                    >
                        Next
                    </button>
                </div>
    ...
    return (
        <div className="max-w-2xl mx-auto p-10 bg-white flex flex-col gap-5">
            <div>
                <p className='text-3xl font-bold text-center'> ADD CHALLENGE</p>
                <div className='p-10 rounded-2xl bg-gray-500 mt-5'>
                    <form>
                        {step === 1 && renderStep1()}
                        {step === 2 && renderStep2()}
                    </form>
